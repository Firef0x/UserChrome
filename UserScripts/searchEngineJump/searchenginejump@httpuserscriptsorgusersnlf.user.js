...
(function () {
	...
	/* 					keyword: function () {
				...
				{name:"UserScripts",
					url:/^https?:\/\/userscripts\.org.*\/scripts\/search/i,
					enabled:true,
					engineList:"web",
					style:'\
						padding-left:5px;\
			...
			engineList.web[3] = {
				name: 'StartPage',
				url: 'https://startpage.com/do/search?cat=web&language=english_uk&query=%s',
				favicon: 'http://startpage.com/favicon.ico',
			};
			engineList.web[4] = {
				name: '360',
			...
			engineList.web[7] = {
				name: '扩展',
				url: 'http://addons.mozilla.org/zh-CN/firefox/search/?q=%s',
				favicon: 'http://addons.cdn.mozilla.net/favicon.ico',
			};
			engineList.web[8] = {
				name: 'AUR',
				url: 'https://aur.archlinux.org/packages/?O=0&do_Search=Go&K=%s',
			...
			engineList.image[0] = {
				name: 'google图片',
				url: 'http://www.google.de/search?tbm=isch&hl=en-US&nfpr=1&safe=off&q=%s',
				favicon: 'data:image/png;base64,',
			};
			engineList.image[1] = {
				name: '百度图片',
