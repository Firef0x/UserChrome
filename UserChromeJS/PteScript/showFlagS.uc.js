...
location == "chrome://browser/content/browser.xul" && (function() {
	...
	var showFlagSconfigFolderPath = "Local";
	var showFlagSconfigFilePath = "_showFlagS.js";
	...
	window.showFlagS = {
		...
		reBuild: function(isAlert) {
			...
			aFile.appendRelativePath(showFlagSconfigFolderPath);
			aFile.appendRelativePath(showFlagSconfigFilePath);
			...
			if (this.showFlagsPer.libIcon)
				this.importLib(this.showFlagsPer.libIconFolder, this.showFlagsPer.libIconPath);
		...
		importLib: function(localFlagFolderPath, localFlagFilePath) {
			...
			// }
			var aFile = Cc["@mozilla.org/file/directory_service;1"].getService(Ci.nsIProperties)
				.get("UChrm", Ci.nsILocalFile);
			aFile.appendRelativePath(localFlagFolderPath);
			aFile.appendRelativePath(localFlagFilePath);
		 
			if (aFile.exists()) {
				userChrome.import(aFile.path, "UChrm");
			}
		},
	};
