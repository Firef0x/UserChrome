...
new function () {
	...
	{label:"搜索此链接文本",url:"https://startpage.com//do/search?cat=web&language=english_uk&query=%LINK_TEXT%",where : "tab",image:"http://startpage.com/favicon.ico"},
	];
	var menu = PageMenu({
...
new function () {
	var items = [
		...
		{label:"搜索所选文本",url:"https://startpage.com//do/search?cat=web&language=english_uk&query=%s",where : "tab",image:"http://startpage.com/favicon.ico"},
