...
location == "chrome://browser/content/browser.xul" && (function () {
        var exeFilePath = [
        "E:\\PortableApps\\goagent\\local\\startgoa.exe",  //启动goagent
        ];
        //点.开头的是profile目录
        ...
        window.addEventListener("unload", function () {
                ...
                if (!WW.hasMoreElements()) {
                        ...
                        // killProcess("py.exe");  //杀掉GoAgent的进程
                        // killProcess("python27.exe");   //新版Goagent
                        // killProcess("python33.exe");   //新版Goagent
                }
        }, false);
